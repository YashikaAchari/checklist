...
import { View, Text, StyleSheet, TouchableOpacity, Modal, Pressable, Alert, Platform } from "react-native";
...
/**
 * Bottom-sheet style picker that lets the user choose between Camera and Gallery.
 * Returns base64-encoded data URLs (so they sync to MongoDB without separate upload).
 */
...
const styles = StyleSheet.create({
  ...
  cancelBtn: { marginTop: 8, padding: 14, alignItems: "center", borderRadius: 10, backgroundColor: t.surfaceAlt },
